    ...
    <template v-slot:top>
      ...
      >
        ...
        >
          ...
          <v-card>
            <v-card-title>
              <span class="headline">New Column</span>
            </v-card-title>
...
/*       {
    ...
    methods: {
      ...
      editColumn (column) {
        this.editedIndex = this.headers.indexOf(column)
      ...
      close2 () {
        this.dialog2 = false
        this.$nextTick(() => {
          this.editedColumn = Object.assign({}, this.defaultItem)
          this.editedIndex = -1
        })
      },
